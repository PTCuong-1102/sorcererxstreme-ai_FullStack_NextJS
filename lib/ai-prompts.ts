...
${wikipediaContext?.content ? `🔍 **NGỮ CẢNH THAM KHẢO TỪ WIKIPEDIA:**
${wikipediaContext.content}

**YÊU CẦU BỔ SUNG:**
- Dựa vào kiến thức của bạn VÀ thông tin trong phần ngữ cảnh tham khảo để đưa ra câu trả lời chính xác nhất.
- Khi bạn sử dụng thông tin từ một nguồn trong ngữ cảnh, hãy đánh dấu nó bằng cú pháp: [nội dung trích dẫn](source:URL_CỦA_NGUỒN).
- Đảm bảo tính chính xác của thông tin bằng cách tham khảo nguồn Wikipedia đáng tin cậy.
...
${wikipediaContext?.content ? '\n- Khi sử dụng thông tin từ nguồn tham khảo, hãy đánh dấu: [nội dung trích dẫn](source:URL_CỦA_NGUỒN)\n- Đảm bảo tính chính xác bằng cách tham khảo nguồn Wikipedia đáng tin cậy' : ''}
